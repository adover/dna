...
const project = 'dna-website-2', // Your project name
	PATHS = {
		src: './src/',
...
gulp.task('browserSync', () => {
	...
	const path = '../../_npm_environment.json',
		defaultConfig = {
			open: 'external',
			host: project + '.test', // this can be anything at .test, or localhost, or...
			proxy: project + '.test', // this needs to be your project (localhost, .test, vagrant domain et al)
			watchTask: true,
			injectChanges: true
		};
